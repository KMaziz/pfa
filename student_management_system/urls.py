...
urlpatterns = [
    ...
    path('add_client', HodViews.add_student,name="add_student"),
        path('add_client', StaffViews.add_student,name="add_student"),
    ...
    path('manage_client', HodViews.manage_student,name="manage_student"),
    ...
    path('client_home', StudentViews.student_home, name="student_home"),
    path('send_files', StudentViews.student_view_attendance, name="student_view_attendance"),
    path('student_view_attendance_post', StudentViews.student_view_attendance_post, name="student_view_attendance_post"),
    path('sent_files', StudentViews.student_apply_leave, name="student_apply_leave"),
    path('student_apply_leave_save', StudentViews.student_apply_leave_save, name="student_apply_leave_save"),
    path('client_feedback', StudentViews.student_feedback, name="student_feedback"),
    path('student_feedback_save', StudentViews.student_feedback_save, name="student_feedback_save"),
    path('student_Companies_save', StudentViews.student_Companies_save, name="student_Companies_save"),
    ...
    path('client_all_notification',StudentViews.student_all_notification,name="student_all_notification"),
    path('client_Companies', StudentViews.student_Companies, name="student_Companies"),
    ...
    path('downloadexcel/<int:pk>/edit',StaffViews.downloadexcel,name="downloadexcel")
